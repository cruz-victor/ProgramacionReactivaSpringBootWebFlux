...
import com.webflux.app.models.dao.ICategoriaDao;
import com.webflux.app.models.dao.IProductoDao;
...
public class ProductoServiceImpl implements IProductoService {
	...
	public Mono<Producto> obtenerPorNombre(String nombre) {
		return iProductoDao.obtenerPorNombre(nombre);
	}

	@Override
	public Mono<Categoria> findCategoriaByNombre(String nombre) {
		return iCategoriaDao.findCategoriaByNombre(nombre);
	}
